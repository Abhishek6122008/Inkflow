...
/// same JWT used for REST, subscribes to the document's broadcast topic and
/// this user's private error queue, and exposes [sendOp] for local edits.
///
  ...
  Future<void> connect() async {
    ...
    final client = StompClient(
      config: StompConfig.SockJS(
        ...
        onWebSocketError: (dynamic error) => onError('CONNECTION_ERROR', error.toString()),
